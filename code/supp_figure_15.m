...
clear
load('Analysis\s_fig15.mat')

%% Fig.S15
wty = IntrinsicFrequency{1, 1}  
wta = IntrinsicFrequency{1, 2}  
j20y = IntrinsicFrequency{1, 3}  
j20a = IntrinsicFrequency{1, 4}  

wty = IntrinsicFrequencyPower{1, 1}  
wta = IntrinsicFrequencyPower{1, 2}  
j20y = IntrinsicFrequencyPower{1, 3}  
j20a = IntrinsicFrequencyPower{1, 4}  
